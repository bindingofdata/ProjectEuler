	...
	class Program
	{
		static void Main ( string[] args )
		{
			...
			*/
			...
			// Loop through the first 17 rows.
			// After that, we only have to test horizontally
			for ( int i = 0; i < 17; i++ )
			{
				for ( int j = 0; j < 20; j++ )
				{
					currentProduct = GetHighestProduct( ref numberGrid, i, j );
			...
			Console.WriteLine( "The Largest Product of 4 numbers is: " + largestProduct );
		...
		private static int GetHighestProduct ( ref int[,] numberArray, int i, int j )
		{
			int largestProduct = 0;
			int testProduct = 0;
